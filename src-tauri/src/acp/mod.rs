...
//! TUI. Protocol classification lives in [`protocol`]; this file owns the child
//! process, handshake, and status tracker.
...
pub(crate) use protocol::{coalesce_update, json_rpc_id, permission_reply};
...
#[cfg(test)]
mod tests {
    use super::protocol::{permission_choice, UPDATE_TEXT_CAP};
    use super::*;
